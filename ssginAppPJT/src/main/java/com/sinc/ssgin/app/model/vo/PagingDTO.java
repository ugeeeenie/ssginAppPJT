...
public class PagingDTO {
	...
	public String toString() {
		return "PagingDTO [pageSize=" + pageSize + ", firstPageNo="
				+ firstPageNo + ", prevPageNo=" + prevPageNo + ", startPageNo="
				+ startPageNo + ", pageNo=" + pageNo + ", endPageNo="
				+ endPageNo + ", nextPageNo=" + nextPageNo + ", finalPageNo="
				+ finalPageNo + ", totalCount=" + totalCount + ", blockSize="
				+ blockSize + ", startRowNum=" + startRowNum + ", endRowNum="
				+ endRowNum + "]";
	}
}
