...
<div class="am-content" style="max-height:570px;">
     	...
     	<div class="row" style="margin:0;">
	        ...
	        <div class="col-sm-12">
	            ...
	            <table style="width:100%;">
	            	<c:forEach items="${notice}" var="notice" varStatus="state">
	            		<tr>
            			  ...
            			  <div class="panel panel-default">
			                <div class="panel-heading danger">
			                  <h4 class="panel-title">
			                  	...
			                  	${notice.notice_seq}&nbsp;&nbsp;&nbsp;${notice.notice_title}
			                ...
			                <div id="ac4-${state.index}" class="panel-collapse collapse">
			                  <div class="panel-body">${notice.notice_content}</div>
			                </div>
			              </div>
	            		</td>
	            		</tr>
  ...
  <!-- <script src="/resources/lib/datatables/js/jquery.dataTables.min.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/js/dataTables.bootstrap.min.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/dataTables.buttons.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/buttons.html5.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/buttons.flash.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/buttons.print.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/buttons.colVis.js" type="text/javascript"></script>
  <script src="/resources/lib/datatables/plugins/buttons/js/buttons.bootstrap.js" type="text/javascript"></script>
  <script src="/resources/js/app-tables-datatables.js" type="text/javascript"></script> -->
  <script type="text/javascript">
    ...
    function prevPage(pageNo){
    	location.href = "/board/notice.app?pageNo=" + (pageNo - 1);
    }
    
    function clickPage(pageNo){
    	location.href = "/board/notice.app?pageNo=" + (pageNo);
    }
